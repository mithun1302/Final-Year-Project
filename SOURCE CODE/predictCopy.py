...
import  numpy as np
SIZE = 120
model = keras.models.load_model(r'C:\Users\RE_cs_3\Desktop\alzheimer-stage-classifier-master\model\model.h5')
categories = ["NonDemented", "MildDemented", "ModerateDemented", "VeryMildDemented"]

nimage = cv2.imread(r"C:\Users\RE_cs_3\Desktop\alzheimer-stage-classifier-master\test\1.jpg", cv2.IMREAD_GRAYSCALE)
